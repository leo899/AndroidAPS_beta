    ...
    class SinocareWorker(
        ...
        override suspend fun doWorkAndLog(): Result {
            ...
            if (collection == "entries"){
                ...
                aapsLogger.debug(LTag.BGSOURCE, "Received Sinocare Data $data")
                if (!data.isNullOrEmpty()){
                    try {
                        ...
                        persistenceLayer.insertCgmSourceData(Sources.Sinocare, glucoseValues, emptyList(), null)
